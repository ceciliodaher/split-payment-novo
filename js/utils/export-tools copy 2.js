...
const ExportTools = {
    ...
    exportarParaPDF: function () {
        ...
        console.log('Estrutura da simulação:', window.ultimaSimulacao);

        // Criar documento PDF mesmo sem verificar estrutura completa
        try {
            ...
            // Adicionar conteúdo básico mesmo se a estrutura estiver incompleta
            this._adicionarConteudoBasico(doc, window.ultimaSimulacao);

            // Se tivermos a estrutura completa, adicionar conteúdo detalhado
            if (this._verificarEstruturaDados(window.ultimaSimulacao)) {
                this._adicionarConteudoDetalhado(doc, window.ultimaSimulacao);
            }
